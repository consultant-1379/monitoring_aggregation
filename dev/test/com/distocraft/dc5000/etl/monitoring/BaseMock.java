...
public abstract class BaseMock {
	 ...
	 * super(testClass); }
	 * 
	 * @Override protected TestMethod wrapMethod(final Method method) { return new
	 * TestMethod(method, getTestClass()) {
	 * 
	 * @Override public void invoke(final Object testFixture) throws
	 * IllegalAccessException, InvocationTargetException {
	 * super.invoke(testFixture); mockeryOf(testFixture).assertIsSatisfied(); } };
	 * 
	 * }
	 * 
	 * }
